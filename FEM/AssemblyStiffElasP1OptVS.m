function M=AssemblyStiffElasP1OptVS(Th,lam,mu)
% function M=AssemblyStiffElasP1OptVS(Th,lam,mu)
...
%    M=AssemblyStiffElasP1OptVS(Th,setFdata(lam,Th),setFdata(mu,Th));
%
...
%   see README for details
  ...
  for i=1:d
    for il=1:d+1
       I=d*(Th.me(il,:)-1)+i;
       M=M+sparse(I,I,lams.*dotMatVecG(Q{i,i},G,il,il)+mus.*dotMatVecG(S{i,i},G,il,il),d*Th.nq,d*Th.nq);
    end
  end
end
